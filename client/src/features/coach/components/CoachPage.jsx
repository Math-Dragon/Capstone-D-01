...
export default function CoachPage() {
  const { messages, status, sendMessage } = useCoach();
      ...
      <div className="flex-1 overflow-y-auto min-h-0 mb-4 pr-1">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-12">
            ...
            <p className="text-sm text-primary-400 max-w-xs leading-relaxed">
              Tanya apa saja tentang strategi belajar, minta perubahan rencana, atau ceritakan
              bagaimana perasaanmu. Saya siap membantu.
            </p>
          </div>
        ) : (
          <>
