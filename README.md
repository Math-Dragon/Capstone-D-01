...
![Halaman login](docs/testing/gemini-readme/screenshots/01-login-page.png)

![Login akun testing](docs/testing/gemini-readme/screenshots/02-login-filled-testing-account.png)
...
![Check-in harian](docs/testing/gemini-readme/screenshots/03-check-in-gateway.png)

Setelah check-in, Dashboard terbuka.

![Dashboard setelah check-in](docs/testing/gemini-readme/screenshots/04-dashboard-after-check-in.png)
...
![Dashboard dengan rencana Gemini](docs/testing/gemini-readme/screenshots/09-dashboard-with-gemini-plan.png)
...
![Coach Gemini](docs/testing/gemini-readme/screenshots/05-coach-home-gemini.png)
...
![Form rencana belajar Gemini](docs/testing/gemini-readme/screenshots/06-coach-plan-form-filled-gemini.png)
...
![Rekomendasi Gemini](docs/testing/gemini-readme/screenshots/07-gemini-recommendation-result.png)

Terima task yang sesuai. Pada testing ini, 5 task diterima dan masuk ke jadwal.

![Task Gemini diterima](docs/testing/gemini-readme/screenshots/08-gemini-tasks-accepted.png)
...
![Daftar target Gemini](docs/testing/gemini-readme/screenshots/10-goals-list-gemini.png)
...
![Detail goal Gemini](docs/testing/gemini-readme/screenshots/11-goal-detail-gemini-tasks.png)
...
![Kalender Today Gemini](docs/testing/gemini-readme/screenshots/12-calendar-today-gemini.png)

### Week View

Mode `Week` menampilkan distribusi rencana belajar satu minggu, total durasi, dan task mendatang.

![Kalender Week Gemini](docs/testing/gemini-readme/screenshots/13-calendar-week-gemini.png)
...
![Progress Gemini](docs/testing/gemini-readme/screenshots/14-progress-gemini.png)
...
![Pertanyaan ke Coach Gemini](docs/testing/gemini-readme/screenshots/15-coach-chat-question-gemini.png)

Coach memberikan jawaban singkat dan actionable.

![Jawaban Coach Gemini](docs/testing/gemini-readme/screenshots/16-coach-chat-response-gemini.png)

## 11. Observability

Panel observability tersedia pada halaman Coach untuk membantu debugging alur AI, audit, dan metrik rekomendasi.

![Observability Coach](docs/testing/gemini-readme/screenshots/17-coach-observability-gemini.png)
