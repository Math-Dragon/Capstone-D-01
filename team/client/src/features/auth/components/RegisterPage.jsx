    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="card p-8">
          ...
          {error && (
            <div className="mb-6 p-4 rounded-xl bg-red-50 border border-red-100 text-red-700 text-sm" role="alert" aria-live="assertive">
              <p className="font-semibold">{error}</p>
              <p className="mt-1 text-red-700">Gunakan email lain atau masuk jika akun sudah terdaftar.</p>
            </div>
          )}

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              <label htmlFor="register-email" className="block text-sm font-medium text-primary-700 mb-2">
                Email
              </label>
              <input
                id="register-email"
            ...
            <div>
              <label htmlFor="register-password" className="block text-sm font-medium text-primary-700 mb-2">
                Password
              </label>
            ...
            <div>
              <label htmlFor="register-confirm-password" className="block text-sm font-medium text-primary-700 mb-2">
                Konfirmasi Password
              </label>
              <div className="relative">
                <input
