        ...
        <div className="card p-8">
          ...
          {error && (
            <div className="mb-6 p-4 rounded-xl bg-red-50 border border-red-100 text-red-700 text-sm" role="alert" aria-live="assertive">
              ...
              <p className="mt-1 text-red-700">Periksa kembali email dan password, lalu coba lagi.</p>
            </div>
          )}

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              <label htmlFor="login-email" className="block text-sm font-medium text-primary-700 mb-2">
                Email
              </label>
              <input
                id="login-email"
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-primary-400">Atau masuk dengan</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                onClick={async () => { try { await loginWithGoogle(); navigate('/'); } catch (error) { void error; } }}
                disabled={loading}
